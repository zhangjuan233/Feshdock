...
from feshdock.constants import DATA_PATH,THRESHOLD

# Disable ProDy output
confProDy(verbosity="info")
log = LoggingManager.get_logger("hierarchical_cluster")
...
if __name__ == "__main__":
    ...
    predict_path = f'{root}/{DATA_PATH}/predict_pdbs/'
    oldpath = predict_path
    newpath = f'{root}/{DATA_PATH}/final_pdbs/'
