"""feshdock default parameters"""

# Simulation defaults
DEFAULT_NUM_SWARMS = 200
...
DATA_PATH='data'
GLOBAL_OUTPUT='gen_ligands'
DE_OUTPUT='candidate_pdbs'
PREDICT_OUTPUT='final_models'
INIT_NUM=120
THRESHOLD=4
DEFAULT_REC_NM_FILE = f"{DATA_PATH}/feshdock_rec.nm"
DEFAULT_LIG_NM_FILE = f"{DATA_PATH}/feshdock_lig.nm"
FFT_EXECT='feshdock/search/global_search'

"""Scoring function constants"""
# feshdock default scoring function if none is specified
...
DEFAULT_POSITIONS_FOLDER =  f"{DATA_PATH}/init"
# Simulation default output file
GSO_OUTPUT_FILE = "de_%s.out"
...
# centered at origin of coordinates (use together with feshdock receptor parsed PDB)
