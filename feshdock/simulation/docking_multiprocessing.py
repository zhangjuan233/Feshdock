...
from feshdock.de.algorithm import LightdockGSOBuilder
from feshdock.mathutil.lrandom import MTGenerator
from feshdock.de.parameters import GSOParameters
...
from feshdock.parallel.kraken import Kraken
from feshdock.parallel.util import GSOClusterTask
from feshdock.scoring.multiple import ScoringConfiguration
from feshdock.structure.nm import read_nmodes
from feshdock.error.feshdock_errors import NotSupportedInScoringError, SwarmNumError
import prody
...
def set_scoring_function(parser, receptor, ligand):
    ...
    for scoring_function, weight in functions.items():
        ...
        scoring_function_module = "feshdock.scoring.%s.driver" % scoring_function
...
def prepare_gso_tasks(parser, adapters, scoring_functions, starting_points_files):
    ...
    for id_swarm in swarm_ids:
        ...
        task = GSOClusterTask(id_swarm, gso, parser.args.steps, DATA_PATH+saving_path)
        tasks.append(task)
    return tasks
