...
import numpy as np
import os
from protein.other_constants import DEFAULT_LIGHTDOCK_PREFIX
from feshdock.scoring.functions import ScoringFunction, ModelAdapter
from feshdock.structure.model import DockingModel
from feshdock.scoring.sipper.data.energy import sipper_energy, res_to_index
import feshdock.scoring.sipper.c.sipper as csipper
