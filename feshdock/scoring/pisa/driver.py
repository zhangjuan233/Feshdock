...
from feshdock.scoring.pisa.cython.cpisa import calculate_pisa
from protein.other_constants import DEFAULT_CONTACT_RESTRAINTS_CUTOFF
...
class PISAPotential(object):
    ...
    def _read_parameters(data_file_name):
        """Reads PISA beans"""
        params_atom_potentials = [
            [
                [0 for k in range(PISAPotential.num_bins)]
    ...
    def get_atom_type(atom_name, res_name):
        ...
        if (
            atom_name == "C"
            or (res_name == "ASN" and atom_name == "CG")
            or (res_name == "GLN" and atom_name == "CD")
        ):
            return 3
        if (
            atom_name == "O"
            or (res_name == "ASN" and atom_name == "OD1")
            or (res_name == "GLN" and atom_name == "OE1")
            or (res_name == "GLN" and atom_name == "OE")
        ):
            return 4
        if atom_name == "CA" and res_name != "PRO":
            return 5
        if (
            (res_name == "ALA" and atom_name == "CB")
            ...
            return 6
        if (
            (res_name == "ARG" and (atom_name == "CB" or atom_name == "CG"))
            ...
            or (
                res_name == "LYS"
                and (atom_name == "CB" or atom_name == "CG" or atom_name == "CD")
            )
        ...
        if res_name == "MET" and atom_name == "CG":
            return 14
        if res_name == "MET" and (
            atom_name == "SD" or atom_name == "S" or atom_name == "SE"
        ):
            return 15
        if res_name == "MET" and atom_name == "CE":
            return 16
        if (res_name == "LYS" and atom_name == "CE") or (
            res_name == "LYS" and atom_name == "CZ"
        ):
            return 17
        if (res_name == "SER" and atom_name == "CB") or (
            res_name == "THR" and atom_name == "CB"
        ):
            return 18
        ...
        if res_name == "CYS" and atom_name == "CB":
            return 20
        if res_name == "CYS" and (
            atom_name == "SG" or atom_name == "S" or atom_name == "SE"
        ):
            return 21
        ...
        if res_name == "ARG" and (atom_name == "NH1" or atom_name == "NH2"):
            return 28
        if (res_name == "ASN" and atom_name == "ND2") or (
            res_name == "GLN" and atom_name == "NE2"
        ):
            return 29
        if (res_name == "ASP" and atom_name == "CB") or (
            res_name == "GLU" and atom_name == "CG"
        ):
            return 30
        if (
            (res_name == "ASP" and atom_name == "CG")
        ...
        if (
            ...
            or (res_name == "GLU" and atom_name == "OE")
            or atom_name == "OX2"
        ):
            return 32
        return -1
...
class PISAAdapter(ModelAdapter):
    ...
    def _get_docking_model(self, molecule, restraints):
        ...
        try:
            ...
            return DockingModel(
                pisa_objects, molecule.copy_coordinates(), parsed_restraints
            )
